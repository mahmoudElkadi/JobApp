...
import 'package:jobchat/core/Network/local/shard_preference.dart';
import 'package:jobchat/core/utils/constants.dart';
import 'package:image_picker/image_picker.dart';
import 'package:image_cropper/image_cropper.dart';
import 'package:jobchat/features/personal%20details/presentation/manger/image%20cubit/image_state.dart';
...
Future <XFile?> cropImage(XFile imageFile)async{
  ...
  void uploadImage(XFile image)async{
    ...
    await CacheHelper.saveData(key: 'imagess', value: imageUrl.toString());
